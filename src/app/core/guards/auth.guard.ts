...
export class AuthGuard implements CanActivate {
  ...
  async canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Promise<boolean> {
    ...
    if (['home/index', 'system/account', 'sms/campaign', 'manager/sender', 'statistic/sms-error','statistic/statistic-data', 'data-sponsor/scenarios','system/account', 'data-sponsor/data-cimast'].indexOf(urlMini.split('?')[0]) < 0) {
