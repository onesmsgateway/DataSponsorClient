...
export class PartnersComponent implements OnInit {
  ...
  public productId;
  public productName;
  public requestHTTP: any;
  public requestSMPP: any;
  ...
  async editPartnerForm() {
    ...
    let REQUEST_BY_HTTP = Number(formData.requestHTTP.value);
    ...
    let REQUEST_BY_SMPP = Number(formData.requestSMPP.value);
